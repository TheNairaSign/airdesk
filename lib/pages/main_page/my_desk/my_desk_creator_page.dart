...
class MyDeskCreatorPage extends StatefulWidget {
  const MyDeskCreatorPage({super.key, this.accessCode});
...
class _MyDeskCreatorPageState extends State<MyDeskCreatorPage> {
  ...
  void initState() {
    super.initState();
    _creatorDeskDataFuture = Provider.of<MyDeskProvider>(context, listen: false).getCreatorDesks(context, load: false, accessCode: widget.accessCode);
  }
  @override
        ...
        child: FutureBuilder<MyDeskData?>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              debugPrint('Submissions: ${deskData.submissions}');
              debugPrint('Submissions length: ${deskData.submissions?.length}');
